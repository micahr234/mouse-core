...
def test_mean_loss_over_passes_trains() -> None:
    ...
    objective = DqnObjective(gamma_step=1.0, grouping_field="task_index", gamma_episode_terminal=0.0, gamma_episode_truncated=0.0, gamma_task_terminal=0.0, gamma_task_truncated=0.0, temperature=0.0)
    out = model(inputs)
    with torch.no_grad():
